...
resource "aws_elasticache_replication_group" "sample_elasticache_replication_group" {
  replication_group_id          = "sample-${var.prefix}-elasticache-replication-group"
  replication_group_description = "sample"
  description                   = "sample ${var.prefix} elasticache replication group"
  engine                        = "redis"
  engine_version = "7.1"
